        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Trang tin tức hàng đầu cập nhật những thông tin mới nhất về công nghệ, 
              kinh doanh, thể thao và nhiều lĩnh vực khác. Chúng tôi cam kết mang đến 
              những tin tức chính xác và kịp thời.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} NewsHub. Tất cả quyền được bảo lưu.
            </p>
